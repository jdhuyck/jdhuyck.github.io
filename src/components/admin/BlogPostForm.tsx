...
const BlogPostForm: React.FC<BlogPostFormProps> = ({
  ...
  const handleSaveDraft = () => {
    // Drafts don't need full validation, just basic checks
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
          <p className="text-sm text-blue-800">
            <strong>Tip:</strong> Use "Save Draft" to save your work without publishing. 
            Drafts are stored locally in your browser and will be available when you return.
          </p>
        </div>
      </div>
    </form>
